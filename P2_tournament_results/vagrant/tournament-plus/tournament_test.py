...
def testReportMatches():
    ...
    reportMatch(id1, id2)
    reportMatch(id3, id4, True) # tied_game
    standings = playerStandings()
    for (i, n, p, m) in standings:
        if m != 1:
            raise ValueError("Each player should have one match recorded.")
        if i == id1 and p != 3:
            raise ValueError("Each match winner should have 3 points recorded.")
        elif i == id2 and p != 0:
            raise ValueError("Each match loser should have zero points recorded.")
        elif i in (id3, id4) and p!=1:
            raise ValueError("Each player with one draw should have 1 point recorded.")
