...
def registerPlayer(name):
    ...
    Args:
      name (str): the player's full name (need not be unique).
    """
    # set query
...
def playerStandings():
    ...
    Returns:
      A list of tuples, each of which contains (id, name, wins, matches):
        ...
        name (str): the player's full name (as registered)
        points (int): the number of points the player has won
...
def reportMatch(winner, loser, draw=False):
    ...
    Args:
      ...
      loser (int):  the id number of the player who lost
      draw (bool): (optional) True if tied game
    """
    # set query
